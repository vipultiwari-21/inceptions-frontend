const EventDetailList = [
  ...
  },
  {
    ...
    rules: [
      "Solo Participant",
      "Number of Participants can participate are : upto 2 per college.",
      "Basic prerequisites are basic computer science, data structures and algorithms, tech related general knowledge, knowledge of using text editors and Languages : C/C++/Java/Python.",
      "Participant must be able to work under distractions.",
      "Participants must report to the venue 15 minutes prior to the event wherein we will explain them the rules of that particular round.",
      "Participants will be given pen and paper.",
      "Participants can bring water bottle in case if they need it.",
      "Systems will be provided with Internet connection.",
      "Participants must not engage in any form malpractice. If found, they will be disqualified immediately.",
      "Mobile Phones are not allowed during the event.",
      "Participants must not switch browsers and search for any solutions.",
    ],
    requirements: [
