const EventDetailList = [
  ...
  },
  {
    ...
    rules: [
      ...
      "Teams must ensure they reach the venue on time and select their problem statements in the time allotted.",
      "Problem statements will be given on a first come first serve basis once teams select their preferred problem statement they will work on that particular project.",
      "Participants are expected to bring their laptops, and charging cables.",
      "Teams can use any web technologies, libraries, frameworks, or open-source code in their projects.",
      "All projects must be developed during the hackathon and cannot have been previously worked on.",
      "Participants must refrain from any illegal or unethical behavior, including hacking or cheating.",
      "Members of a team are not allowed to leave the venue without informing one of the organizers before leaving. Failing to do so will lead to the disqualification of the entire team.",
